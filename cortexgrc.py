...
- FRAMEWORK_SERVICE_URL: URL for framework optimizer (default: https://framework.autogrc.cloud)
...
FRAMEWORK_SERVICE_URL = os.getenv("FRAMEWORK_SERVICE_URL", "https://framework.autogrc.cloud")
