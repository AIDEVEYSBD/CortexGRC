...
- FRAMEWORK_SERVICE_URL: URL for framework optimizer (default: http://localhost:8001)
...
FRAMEWORK_SERVICE_URL = os.getenv("FRAMEWORK_SERVICE_URL", "http://localhost:8001")
